...
//         const response = await fetch(`${API_URL}/vendor/fetch-vendor-data?id=${session.user.id}`, {
//           cache: 'no-store',
//           headers: {
//             'pragma': 'no-cache',
...
//       fetchVendorData()
//     }
//   }, [session, refreshTrigger, API_URL])
...
//           // Continuation from the code provided
// // This completes the VendorUpdate component and the main page component
