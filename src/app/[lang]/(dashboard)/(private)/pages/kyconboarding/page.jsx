...
// import { Box, Typography, Snackbar, Alert, Button, TextField, Dialog, DialogTitle, DialogContent, DialogActions, IconButton } from '@mui/material'
...
//   try {
//     const response = await axios.get(`https://pmwapis.parkmywheels.com/vendor/fetch-vendor-data?id=${vendorId}`);
...
//     try {
//       await axios.delete(`https://pmwapis.parkmywheels.com/admin/delete/${selectedKyc.id}`)
...
const KycDataTable = () => {
  ...
  const handleEditClick = async (item) => {
    try {
      setLoading(true)
      const response = await axios.get(`https://pmwapis.parkmywheels.com/vendor/getkyc/${item.vendorId}`)
  ...
  const handleEditSubmit = async () => {
    try {
      ...
      const response = await axios.put(
        `https://pmwapis.parkmywheels.com/vendor/updatekyc/${selectedKyc.vendorId}`,
        formData,
        {
          headers: {
