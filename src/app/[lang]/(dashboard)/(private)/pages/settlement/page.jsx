...
const VendorSettlementModal = ({ open, handleClose, vendorId }) => {
    ...
    const handleSelectAll = (event) => {
        if (event.target.checked) {
            ...
            setSelectedRows((prev) => [...new Set([...prev, ...newSelected])]);
        } else {
            // Only remove rows that are on the current page
            const currentPageIds = settlementData.map((row) => row._id);
    ...
    const columns = [
        {
            ...
            renderHeader: () => (
                <Checkbox
                    ...
                    indeterminate={
                        ...
                        selectedRows.length < settlementData.length
                    }
                    checked={
                        settlementData.length > 0 &&
                        selectedRows.length === settlementData.length
            ...
            renderCell: (params) => (
                <Checkbox
                    ...
                    onChange={() => {
                        const newSelected = selectedRows.includes(params.row._id)
                ...
                {loading ? (
                    ...
                    <>
                        <Box sx={{ mb: 3 }}>
                            ...
                            <Typography variant="body2" color="text.secondary">
                                {selectedRows.length > 0
                                    ? `${selectedRows.length} selected of ${rowCount} total records`
                            ...
                            {selectedRows.length > 0 ? (
                                <>
                                    <Typography variant="subtitle2" sx={{ mb: 2 }}>
                                        Selected {selectedRows.length} booking(s)
                                    </Typography>
                                    <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 3 }}>
                                        <Box>
                                        ...
                                        <Box>
                                            ...
                                            <Typography variant="h6">{formatCurrency(selectedTotals.gstamout)}</Typography>
                                        </Box>
                                        <Box>
                                            <Typography variant="body2" color="text.secondary">Selected Total Amount</Typography>
                                            <Typography variant="h6">{formatCurrency(selectedTotals.totalamout)}</Typography>
                                        </Box>
                                        <Box>
                                ...
                                <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 3 }}>
                                    <Box>
                                        <Typography variant="body2" color="text.secondary">Total Amount</Typography>
                                        <Typography variant="h6">{formatCurrency(allTotals.amount)}</Typography>
                                    </Box>
                                    <Box>
                                        <Typography variant="body2" color="text.secondary">Total GST</Typography>
                                        <Typography variant="h6">{formatCurrency(allTotals.gstamout)}</Typography>
                                    </Box>
                                    <Box>
                                        <Typography variant="body2" color="text.secondary">Total Payable</Typography>
                                        <Typography variant="h6">{formatCurrency(allTotals.totalamout)}</Typography>
                                    </Box>
                                    <Box>
                                        <Typography variant="body2" color="text.secondary">Total Release Fee</Typography>
                                        <Typography variant="h6">{formatCurrency(allTotals.releasefee)}</Typography>
                                    </Box>
                                    <Box>
                                        <Typography variant="body2" color="text.secondary">Total Receivable</Typography>
                                        <Typography variant="h6" color="#329a73" fontWeight="bold">
                                            {formatCurrency(allTotals.recievableamount)}
                                        </Typography>
                                    </Box>
                                </Box>
                            )}
            ...
            <DialogActions>
                ...
                {selectedRows.length > 0 && (
                    <Button 
                        ...
                        color="primary"
                        onClick={() => {
                            // Handle action for selected rows
