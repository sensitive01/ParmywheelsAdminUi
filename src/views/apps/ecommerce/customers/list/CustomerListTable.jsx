...
<Dialog open={rescheduleModalOpen} onClose={() => setRescheduleModalOpen(false)} maxWidth="md" fullWidth>
  ...
  <Tabs value={currentTab} onChange={handleTabChange} aria-label="customer details tabs" variant="scrollable" scrollButtons="auto">
    ...
    <Tab icon={<AccessTimeIcon fontSize="small" />} iconPosition="start" label="Myspac Business Hours" />
    <Tab icon={<i className="ri-list-check" />} iconPosition='start' label=" My spac Amenities"/>
    <Tab icon={<MonetizationOnIcon fontSize="small" />} iconPosition="start" label="Myspac Services & Pricing" />
    <Tab icon={<ChatIcon fontSize="small" />} iconPosition="start" label="Myspac Support Requests" />
    <Tab icon={<i className="ri-bank-line" />} iconPosition='start' label="Myspac Bank Details"/>
    <Tab icon={<i className="ri-calendar-line" />} iconPosition='start' label="Myspac Advertise With Us"/>
    <Tab icon={<i className="ri-money-dollar-circle-line" />} iconPosition="start" label="Myspac Booking Transactions" />
    <Tab icon={<i className="ri-car-line" />} iconPosition="start" label="Myspac Bookings" />
    <Tab icon={<i className="ri-money-dollar-circle-line" />} iconPosition="start" label="Myspac Parking Charges" />
